        ...
        Describe("CurrentSessionReducer")
            .As(() =>
            {
                    ...
                    .As(() =>
                    {
                        BeforeEach(() =>
                        {
                            state = _initialState with
                            {
                                ...
                                {
                                    RecordedExercises =
                                        _initialState.WorkoutSession!.RecordedExercises.SetItem(
                                            1,
                        ...
                        It("Should only update sets which are incomplete")
                            .When(() =>
                            {
                                ...
                                var newState = CurrentSessionReducers.UpdateExerciseWeight(
                                    _initialState,
                                    action
                                );
                ...
                Describe("When PerSetWeight is false")
                    ...
                    {
                        It(
                                "Should always update all sets to have the same weight even if one is completed"
                            )
                            .When(() =>
                            {
                                var action = new UpdateExerciseWeightAction(
