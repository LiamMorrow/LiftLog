...
using System;
namespace RevenueCat.Client.Projects.Item.Purchases.Item.Entitlements
{
    /// <summary>
    /// Builds and executes requests for operations under \projects\{project_id}\purchases\{purchase_id}\entitlements
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class EntitlementsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RevenueCat.Client.Projects.Item.Purchases.Item.Entitlements.EntitlementsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EntitlementsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{project_id}/purchases/{purchase_id}/entitlements{?limit*,starting_after*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RevenueCat.Client.Projects.Item.Purchases.Item.Entitlements.EntitlementsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EntitlementsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{project_id}/purchases/{purchase_id}/entitlements{?limit*,starting_after*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::RevenueCat.Client.Models.ListEntitlements?> GetAsync(Action<RequestConfiguration<global::RevenueCat.Client.Projects.Item.Purchases.Item.Entitlements.EntitlementsRequestBuilder.EntitlementsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RevenueCat.Client.Models.ListEntitlements> GetAsync(Action<RequestConfiguration<global::RevenueCat.Client.Projects.Item.Purchases.Item.Entitlements.EntitlementsRequestBuilder.EntitlementsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::RevenueCat.Client.Projects.Item.Purchases.Item.Entitlements.EntitlementsRequestBuilder.EntitlementsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::RevenueCat.Client.Projects.Item.Purchases.Item.Entitlements.EntitlementsRequestBuilder.EntitlementsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::RevenueCat.Client.Projects.Item.Purchases.Item.Entitlements.EntitlementsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RevenueCat.Client.Projects.Item.Purchases.Item.Entitlements.EntitlementsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::RevenueCat.Client.Projects.Item.Purchases.Item.Entitlements.EntitlementsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists all Entitlements granted by a Purchase. This endpoint requires the following permission(s): &lt;code&gt;customer_information:purchases:read&lt;/code&gt;.
        /// </summary>
