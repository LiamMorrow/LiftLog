...
using System;
namespace RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance
{
    /// <summary>
    /// Builds and executes requests for operations under \projects\{project_id}\customers\{customer_id}\virtual_currencies\update_balance
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class Update_balanceRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balanceRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Update_balanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{project_id}/customers/{customer_id}/virtual_currencies/update_balance{?include_empty_balances*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balanceRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Update_balanceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{project_id}/customers/{customer_id}/virtual_currencies/update_balance{?include_empty_balances*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::RevenueCat.Client.Models.ListVirtualCurrenciesBalances?> PostAsync(global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balancePostRequestBody body, Action<RequestConfiguration<global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balanceRequestBuilder.Update_balanceRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::RevenueCat.Client.Models.ListVirtualCurrenciesBalances> PostAsync(global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balancePostRequestBody body, Action<RequestConfiguration<global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balanceRequestBuilder.Update_balanceRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balancePostRequestBody body, Action<RequestConfiguration<global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balanceRequestBuilder.Update_balanceRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balancePostRequestBody body, Action<RequestConfiguration<global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balanceRequestBuilder.Update_balanceRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balanceRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balanceRequestBuilder WithUrl(string rawUrl)
        {
            return new global::RevenueCat.Client.Projects.Item.Customers.Item.Virtual_currencies.Update_balance.Update_balanceRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// This endpoint requires the following permission(s): &lt;code&gt;customer_information:purchases:read_write&lt;/code&gt;.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class Update_balanceRequestBuilderPostQueryParameters 
        {
