    ...
    >
      ...
      {entry.kind === 'weighted' ? (
        <Button
          ...
          onPress={() =>
            push(
              `/(tabs)/progress/expanded-weighted-exercise?exerciseName=${encodeURIComponent(entry.exerciseName)}` as never,
            )
          }
        >
      ...
      <Button mode="text" onPress={() => dismissTo('/(tabs)/progress' as never)}>
