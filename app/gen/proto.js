        ...
        Ui.Models = (function() {
            ...
            Models.WorkoutMessage = (function() {
                ...
                WorkoutMessage.WorkoutUpdatedEvent = (function() {
                     ...
                     * @property {LiftLog.Ui.Models.WorkoutMessage.ITimerInfo|null} [timerInfo] WorkoutUpdatedEvent timerInfo
                    ...
                    /**
                     * WorkoutUpdatedEvent timerInfo.
                     * @member {LiftLog.Ui.Models.WorkoutMessage.ITimerInfo|null|undefined} timerInfo
                     * @memberof LiftLog.Ui.Models.WorkoutMessage.WorkoutUpdatedEvent
                     * @instance
                     */
                    WorkoutUpdatedEvent.prototype.timerInfo = null;
                    ...
                    /**
                     * WorkoutUpdatedEvent _timerInfo.
                     * @member {"timerInfo"|undefined} _timerInfo
                     * @memberof LiftLog.Ui.Models.WorkoutMessage.WorkoutUpdatedEvent
                     * @instance
                     */
                    Object.defineProperty(WorkoutUpdatedEvent.prototype, "_timerInfo", {
                        get: $util.oneOfGetter($oneOfFields = ["timerInfo"]),
                        set: $util.oneOfSetter($oneOfFields)
                    });
                    ...
                    WorkoutUpdatedEvent.encode = function encode(message, writer) {
                        ...
                        if (message.timerInfo != null && Object.hasOwnProperty.call(message, "timerInfo"))
                            $root.LiftLog.Ui.Models.WorkoutMessage.TimerInfo.encode(message.timerInfo, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                        if (message.totalWeightLifted != null && Object.hasOwnProperty.call(message, "totalWeightLifted"))
                            $root.LiftLog.Ui.Models.Weight.encode(message.totalWeightLifted, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                        if (message.workoutDuration != null && Object.hasOwnProperty.call(message, "workoutDuration"))
                            $root.google.protobuf.Duration.encode(message.workoutDuration, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                        return writer;
                    };
                    ...
                    WorkoutUpdatedEvent.decode = function decode(reader, length, error) {
                        ...
                        while (reader.pos < end) {
                            ...
                            case 3: {
                                    message.timerInfo = $root.LiftLog.Ui.Models.WorkoutMessage.TimerInfo.decode(reader, reader.uint32());
                                    break;
                                }
                            case 4: {
                    ...
                    WorkoutUpdatedEvent.verify = function verify(message) {
                        ...
                        if (message.timerInfo != null && message.hasOwnProperty("timerInfo")) {
                            properties._timerInfo = 1;
                            {
                                let error = $root.LiftLog.Ui.Models.WorkoutMessage.TimerInfo.verify(message.timerInfo);
                                if (error)
                                    return "timerInfo." + error;
                            }
                        }
                    ...
                    WorkoutUpdatedEvent.fromObject = function fromObject(object) {
                        ...
                        if (object.timerInfo != null) {
                            if (typeof object.timerInfo !== "object")
                                throw TypeError(".LiftLog.Ui.Models.WorkoutMessage.WorkoutUpdatedEvent.timerInfo: object expected");
                            message.timerInfo = $root.LiftLog.Ui.Models.WorkoutMessage.TimerInfo.fromObject(object.timerInfo);
                        }
                    ...
                    WorkoutUpdatedEvent.toObject = function toObject(message, options) {
                        ...
                        if (message.timerInfo != null && message.hasOwnProperty("timerInfo")) {
                            object.timerInfo = $root.LiftLog.Ui.Models.WorkoutMessage.TimerInfo.toObject(message.timerInfo, options);
                            if (options.oneofs)
                                object._timerInfo = "timerInfo";
                        }
                        if (message.totalWeightLifted != null && message.hasOwnProperty("totalWeightLifted"))
                ...
                WorkoutMessage.TimerInfo = (function() {

                    /**
                     * Properties of a TimerInfo.
                     * @memberof LiftLog.Ui.Models.WorkoutMessage
                     * @interface ITimerInfo
                     * @property {google.protobuf.ITimestamp|null} [startedAt] TimerInfo startedAt
                     * @property {google.protobuf.ITimestamp|null} [partiallyEndAt] TimerInfo partiallyEndAt
                     * @property {google.protobuf.ITimestamp|null} [endAt] TimerInfo endAt
                     */

                    /**
                     * Constructs a new TimerInfo.
                     * @memberof LiftLog.Ui.Models.WorkoutMessage
                     * @classdesc Represents a TimerInfo.
                     * @implements ITimerInfo
                     * @constructor
                     * @param {LiftLog.Ui.Models.WorkoutMessage.ITimerInfo=} [properties] Properties to set
                     */
                    function TimerInfo(properties) {
                        if (properties)
                            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                                if (properties[keys[i]] != null)
                                    this[keys[i]] = properties[keys[i]];
                     ...
                     * @memberof LiftLog.Ui.Models.WorkoutMessage.TimerInfo
                     * @instance
                     */
                    TimerInfo.prototype.startedAt = null;

                    /**
                     * TimerInfo partiallyEndAt.
                     * @member {google.protobuf.ITimestamp|null|undefined} partiallyEndAt
                     * @memberof LiftLog.Ui.Models.WorkoutMessage.TimerInfo
                     * @instance
                     */
                    TimerInfo.prototype.partiallyEndAt = null;
                     ...
                     * @instance
                     */
                    TimerInfo.prototype.endAt = null;
                     ...
                     * @static
                     * @param {LiftLog.Ui.Models.WorkoutMessage.ITimerInfo=} [properties] Properties to set
                     * @returns {LiftLog.Ui.Models.WorkoutMessage.TimerInfo} TimerInfo instance
                     */
                    TimerInfo.create = function create(properties) {
                        return new TimerInfo(properties);
                    };

                    /**
                     * Encodes the specified TimerInfo message. Does not implicitly {@link LiftLog.Ui.Models.WorkoutMessage.TimerInfo.verify|verify} messages.
                     * @function encode
                     * @memberof LiftLog.Ui.Models.WorkoutMessage.TimerInfo
                     * @static
                     * @param {LiftLog.Ui.Models.WorkoutMessage.ITimerInfo} message TimerInfo message or plain object to encode
                     * @param {$protobuf.Writer} [writer] Writer to encode to
                     * @returns {$protobuf.Writer} Writer
                     */
                    TimerInfo.encode = function encode(message, writer) {
                        if (!writer)
                            writer = $Writer.create();
                    ...
                    /**
                     * Encodes the specified TimerInfo message, length delimited. Does not implicitly {@link LiftLog.Ui.Models.WorkoutMessage.TimerInfo.verify|verify} messages.
                     * @function encodeDelimited
                     * @memberof LiftLog.Ui.Models.WorkoutMessage.TimerInfo
                     * @static
                     * @param {LiftLog.Ui.Models.WorkoutMessage.ITimerInfo} message TimerInfo message or plain object to encode
                     ...
                     * @returns {$protobuf.Writer} Writer
                     */
                    TimerInfo.encodeDelimited = function encodeDelimited(message, writer) {
                        return this.encode(message, writer).ldelim();
                    };
                     ...
                     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
                     * @param {number} [length] Message length if known beforehand
                     * @returns {LiftLog.Ui.Models.WorkoutMessage.TimerInfo} TimerInfo
                     * @throws {Error} If the payload is not a reader or valid buffer
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    TimerInfo.decode = function decode(reader, length, error) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.LiftLog.Ui.Models.WorkoutMessage.TimerInfo();
                        while (reader.pos < end) {
                            let tag = reader.uint32();
                            if (tag === error)
                                break;
                     ...
                     * @throws {$protobuf.util.ProtocolError} If required fields are missing
                     */
                    TimerInfo.decodeDelimited = function decodeDelimited(reader) {
                        if (!(reader instanceof $Reader))
                            reader = new $Reader(reader);
                        return this.decode(reader, reader.uint32());
                    };
                     ...
                     * @returns {string|null} `null` if valid, otherwise the reason why it is not
                     */
                    TimerInfo.verify = function verify(message) {
                        if (typeof message !== "object" || message === null)
                            return "object expected";
                     ...
                     * @returns {LiftLog.Ui.Models.WorkoutMessage.TimerInfo} TimerInfo
                     */
                    TimerInfo.fromObject = function fromObject(object) {
                        if (object instanceof $root.LiftLog.Ui.Models.WorkoutMessage.TimerInfo)
                            return object;
                        let message = new $root.LiftLog.Ui.Models.WorkoutMessage.TimerInfo();
                        if (object.startedAt != null) {
                            if (typeof object.startedAt !== "object")
                                throw TypeError(".LiftLog.Ui.Models.WorkoutMessage.TimerInfo.startedAt: object expected");
                        ...
                        if (object.partiallyEndAt != null) {
                            if (typeof object.partiallyEndAt !== "object")
                                throw TypeError(".LiftLog.Ui.Models.WorkoutMessage.TimerInfo.partiallyEndAt: object expected");
                        ...
                        if (object.endAt != null) {
                            if (typeof object.endAt !== "object")
                                throw TypeError(".LiftLog.Ui.Models.WorkoutMessage.TimerInfo.endAt: object expected");
                     ...
                     * @memberof LiftLog.Ui.Models.WorkoutMessage.TimerInfo
                     * @static
                     * @param {LiftLog.Ui.Models.WorkoutMessage.TimerInfo} message TimerInfo
                     * @param {$protobuf.IConversionOptions} [options] Conversion options
                     * @returns {Object.<string,*>} Plain object
                     */
                    TimerInfo.toObject = function toObject(message, options) {
                        if (!options)
                            options = {};
                        let object = {};
                        if (options.defaults) {
                     ...
                     * @returns {Object.<string,*>} JSON object
                     */
                    TimerInfo.prototype.toJSON = function toJSON() {
                        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                    };

                    /**
                     * Gets the default type url for TimerInfo
                     * @function getTypeUrl
                     * @memberof LiftLog.Ui.Models.WorkoutMessage.TimerInfo
                     * @static
                     * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
                     * @returns {string} The default type url
                     */
                    TimerInfo.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                        if (typeUrlPrefix === undefined) {
                            typeUrlPrefix = "type.googleapis.com";
                        }
                        return typeUrlPrefix + "/LiftLog.Ui.Models.WorkoutMessage.TimerInfo";
                    };
