import { WeightedExerciseBlueprintJSON, ProgressiveOverloadJSON } from '@/models/storage/versions/initial';
import { fromBigNumberJSON } from '@/models/storage/versions/libs';
import { omit } from '@/utils/omit';

export function addProgressiveOverloadToExercise(ex: WeightedExerciseBlueprintJSON) {
  return {
